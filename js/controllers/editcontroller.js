'use strict';
libApp.controller('editcontroller', function editcontroller($scope) {
  console.log("in the edit ctrl");
  $scope.setIcon = function(submit) {
    console.log("Hello!");
    console.log("s.icon: ", submit.techIcon);
    //FIXME: ???!//
  }
